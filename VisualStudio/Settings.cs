...
namespace RetroTexturesMod
{
    internal class Settings : JsonModSettings
    {
        ...
        [Name("Sodas")]
        [Description("Changes the sodas Texture and Inventory Icon to the old one.")]
        ...
        [Name("Sodas")]
        [Description("Replaces the Sodas Texture and Inventory Icon. Disable respective item in Food Category before applying! (Game Restart Required)")]
        ...
        public static void ApplyReset()
        {
            if (instance.ResetSettings == true)
            {
                ...
                instance.Prybar = false;
                instance.Tools = false;
