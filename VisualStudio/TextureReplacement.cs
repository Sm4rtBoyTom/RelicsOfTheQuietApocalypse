...
internal class RetroTextureSwap
{
    ...
    private static class ReplaceTextures
    {
        private static void Postfix()
        {
            ...
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_Accelerant", "Accelerant_Old", "GEAR_Accelerant_Dif_Old", 0);
            }
            if (Settings.instance.WoodMatches)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_WoodMatches", "OBJ_WoodMatches_Old", "GEAR_MatchesFlare_Dif", 0);
            }
            if (Settings.instance.Book)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BookA", "BookA_LOD0", "GEAR_BookA_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BookB", "BookB_LOD0", "GEAR_BookA_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BookBopen", "BookBopen_LOD0", "GEAR_BookA_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BookC", "BookC_LOD0", "GEAR_BookA_Dif", 0);
            }
            if (Settings.instance.HydrogenPeroxide) //FirstAid Category
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BottleHydrogenPeroxide", "BottleHydrogenPeroxide_LOD0", "GEAR_HydrogenPeroxide_Dif", 0);
            }
            if (Settings.instance.PainKillers)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BottlePainKillers", "BottlePainKillers_LOD0", "GEAR_BottlePainKillers_Dif", 0);
            }
            if (Settings.instance.ReishiTea)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_ReishiTea", "ReishiTea_LOD0", "GEAR_ReishiTeaCup_Dif", 0);
            }
            if (Settings.instance.RosehipTea)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_RoseHipTea", "RoseHipTea_LOD0", "GEAR_RosehipTeaCup_Dif", 0);
            }
            if (Settings.instance.WaterTablets)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_WaterPurificationtablets", "WaterPurificationTablets_LOD0", "GEAR_WaterPurificationTablets_Dif", 0);
            }
            if (Settings.instance.BeefJerky)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BeefJerky", "BeefJerky_Old", "GEAR_BeefJerky_Dif", 0);
            }
            if (Settings.instance.CandyBar)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CandyBar", "CandyBarMesh", "GEAR_CandyBar_Dif", 0);
            }
            if (Settings.instance.CattailStalk)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CattailStalk", "CattailStalkMesh", "GEAR_CattailStalk_Dif", 0);
            }
            if (Settings.instance.Milk)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CondensedMilk", "CannedFoodMesh_Old", "GEAR_CondensedMilk_Dif", 0);
            }
            if (Settings.instance.CoffeeCup)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CoffeeCup", "Mesh", "GEAR_CoffeeCup_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CoffeeTin", "OBJ_CoffeeTin_Old", "GEAR_CoffeeTin_Dif", 0);
            }
            if (Settings.instance.GreenTeaCup)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_GreenTeaCup", "Mesh", "GEAR_GreenTeaCup_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_GreenTeaPackage", "OBJ_GreenTeaPackage_Old", "GEAR_GreenTeaPackage_Dif", 0);
            }
            if (Settings.instance.DogFood)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_Dogfood", "CannedFoodMesh_Old", "GEAR_DogFood_Dif", 0);
            }
            if (Settings.instance.EnergyBar)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_EnergyBar", "CandyBarMesh_Old", "GEAR_EnergyBar_Dif", 0);
            }
            if (Settings.instance.GranolaBar)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_GranolaBar", "GranolaBarMesh", "GEAR_GranolaBar_Dif", 0);
            }
            if (Settings.instance.MRE)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_MRE", "Obj_FoodMRE_Old", "GEAR_MRE_Dif", 0);
            }
            if (Settings.instance.Soda)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_SodaOrange", "FoodSodaCan_Old", "GEAR_SodaOrange_Dif", 0);
            }
            if (Settings.instance.PeanutButter)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_PeanutButter", "PeanutButter_Old", "GEAR_PeanutButter_Dif", 0);
            }
            if (Settings.instance.Peaches)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_PinnacleCanPeaches", "OBJ_CannedFood_Old", "GEAR_PinnacleCanPeaches_Dif", 0);
            }
            if (Settings.instance.Beans)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CannedBeans", "OBJ_CannedFood_Old", "GEAR_CannedBeans_Dif", 0);
            }
            if (Settings.instance.Crackers)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_Crackers", "OBJ_BoxedCrackers_Old", "GEAR_Crackers_Dif", 0);
            }
            if (Settings.instance.Soda)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_SodaGrape", "FoodSodaCan_Old", "GEAR_SodaGrape_Dif", 0);
            }
            if (Settings.instance.Soda)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_Soda", "FoodSodaCan_Old", "GEAR_Soda_Dif", 0);
            }
            if (Settings.instance.Sardines)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CannedSardines", "CannedFoodMesh_Old", "GEAR_CannedSardines_Dif", 0);
            }
            if (Settings.instance.TomatoSoup)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_TomatoSoupCan", "CannedFoodMesh_Old", "GEAR_TomatoSoupCan_Dif", 0);
            }
            if (Settings.instance.BearSkinBedroll) //Tools Category
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BearSkinBedRoll", "BedRollMesh", "GEAR_BearSkinBedRoll_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BearSkinBedRoll", "BedRollPlacedMesh", "GEAR_BearSkinBedRoll_Dif", 0);
            }
            if (Settings.instance.Bedroll)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BedRoll", "BedRollMesh", "GEAR_BedRoll_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BedRoll", "BedRollPlacedMesh", "GEAR_BedRoll_Dif", 0);
            }
            if (Settings.instance.CanOpener)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CanOpener", "OBJ_CanOpener", "GEAR_CanOpener_Dif", 0);
            }
            if (Settings.instance.Hatchet)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_Hatchet", "OBJ_Hatchet", "GEAR_Hatchet_Dif", 0);
            }
            if (Settings.instance.JerryCan)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_JerrycanRusty", "JerrycanRusty_LOD0", "GEAR_Jerrycan_Dif", 0);
            }
            if (Settings.instance.LampFuel)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_LampFuelFull", "LampFuel_LOD0", "GEAR_LampFuel_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_LampFuel", "LampFuel_LOD0", "GEAR_LampFuel_Dif", 0);
            }
            if (Settings.instance.Prybar)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_Prybar", "OBJ_PryBar_LOD0", "GEAR_PryBar_Dif", 0);
            }
            if (Settings.instance.Tools)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_SimpleTools", "SimpleTools_LOD0", "GEAR_SimpleTools_Dif", 0);
            }
            if (Settings.instance.SewingKit)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_SewingKit", "SewingKitMesh", "GEAR_SewingKit_Dif", 0);
            }
            if (Settings.instance.Cloth)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_Cloth", "Cloth_LOD0", "GEAR_Cloth_Dif", 0);
            }
            if (Settings.instance.Reishi)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_ReishiMushroom", "ReishiMushroom_LOD0", "GEAR_ReishiMushroom_Dif", 0);
            }
            if (Settings.instance.Rosehip)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_RoseHip", "RoseHip_LOD0", "GEAR_RoseHip_Dif", 0);
            }
            if (Settings.instance.HarvestBook) //Research Books
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BookCarcassHarvesting", "Mesh", "GEAR_BookCarcassHarvesting_Dif", 1);
            }
            if (Settings.instance.GunBook)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BookRifleFirearm", "Mesh", "GEAR_BookRifleFirearm_Dif", 0);
            }
            if (Settings.instance.CookingBook)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BookCooking", "Mesh", "GEAR_BookCooking_Dif", 1);
            }
            if (Settings.instance.IceFishing)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BookIceFishing", "Mesh", "GEAR_BookIceFishing_Dif", 0);
            }
            if (Settings.instance.FireBook)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BookFireStarting", "Mesh", "GEAR_BookFireStarting_Dif", 1);
            }
            if (Settings.instance.GunsAdvanced)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_BookRifleFirearmAdvanced", "Mesh", "GEAR_BookRifleFirearmAdvanced_Dif", 0);
            }
            if (Settings.instance.Soda_Old) // Cut Content
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_Soda", "FoodSodaCan_LOD0", "GEAR_FoodSodaSummitCut_Dif", 1);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_Soda", "FoodSodaCan_LOD1", "GEAR_FoodSodaSummitCut_Dif", 1);

                TextureReplacementLogic.SwapGearItemTexture("GEAR_SodaOrange", "FoodSodaCan_LOD0", "GEAR_FoodSodaOrangeCut_Dif", 1);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_SodaOrange", "FoodSodaCan_LOD1", "GEAR_FoodSodaOrangeCut_Dif", 1);

                TextureReplacementLogic.SwapGearItemTexture("GEAR_SodaGrape", "FoodSodaCan_LOD0", "GEAR_FoodSodaGrapeCut_Dif", 1);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_SodaGrape", "FoodSodaCan_LOD1", "GEAR_FoodSodaGrapeCut_Dif", 1);
            }
            if (Settings.instance.CoffeeTin_Old)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CoffeeTin", "OBJ_CoffeeTin_LOD0", "GEAR_CoffeeTinCut_Dif", 0);
       //         TextureReplacementLogic.SwapGearItemTexture("GEAR_CoffeeTin", "OBJ_CoffeeTin_LOD1", "GEAR_CoffeeTinCut_Dif", 0);
            }
            if (Settings.instance.Crackers_Old)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_Crackers", "OBJ_BoxedCrackers_LOD0", "GEAR_BoxedCrackersCut_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_Crackers", "OBJ_BoxedCrackers_LOD1", "GEAR_BoxedCrackersCut_Dif", 0);
            }
            if (Settings.instance.MRE_Old)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_MRE", "Obj_FoodMRE_LOD0", "GEAR_FoodMRECut_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_MRE", "Obj_FoodMRE_LOD1", "GEAR_FoodMRECut_Dif", 0);
            }
            if (Settings.instance.Peaches_Old)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_PinnacleCanPeaches", "OBJ_CannedFood", "GEAR_FoodCannedPeachesCut_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_PinnacleCanPeaches", "OBJ_CannedBeansUsed", "GEAR_FoodCannedPeachesCut_Dif", 1);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_PinnacleCanPeaches", "OpenedMesh/OBJ_CannedBeansUsed", "GEAR_FoodCannedPeachesCut_Dif", 1);
            }
            if (Settings.instance.Beans_Old)
            {
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CannedBeans", "OBJ_CannedFood", "GEAR_FoodPorkAndBeansCut_Dif", 0);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CannedBeans", "OBJ_CannedBeansUsed", "GEAR_FoodPorkAndBeansCut_Dif", 1);
                TextureReplacementLogic.SwapGearItemTexture("GEAR_CannedBeans", "OpenedMesh/OBJ_CannedBeansUsed", "GEAR_FoodPorkAndBeansCut_Dif", 1);
    ...
    internal static string GetTextureNameForGearItem(GearItem gi)
    {
        ...
        if (gi.name == "GEAR_CattailStalk" && !Settings.instance.CattailStalk)
        {
            return string.Empty;
        }
